...
int main(int, char**)
{
    ...
    if (!Global::dx_init)
    {
        ...
        io.IniFilename = NULL;
       // bool ret = LoadTextureFromFile(xorstr("C:\\logo.png"), &Global::my_texture, &Global::my_image_width, &Global::my_image_height);
      //  IM_ASSERT(ret);
        io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\arialbi.ttf", 14);
        gui::init_style();
    }
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        ColorChange();
        Global::RGB = { color_red, color_green, color_blue, 255 };
        gui::draw_menu();
